...
- Deps update dependency @kn-ui/icons-vue to v2 (#7976 by @renovate[bot])
...
- Deps update dependency @kn-ui/icons-vue to v1 (#6319 by @renovate[bot])
...
- Upgrade @kn-ui/icons-vue to currentColor (#4671 by @YunYouJun)
...
- Docs replace @element-plus/icons with @kn-ui/icons-vue (#4704 by @pdsuwwz)
