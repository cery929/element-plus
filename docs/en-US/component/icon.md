...
```shell [npm]
$ npm install @kn-ui/icons-vue
```

```shell [yarn]
$ yarn add @kn-ui/icons-vue
```

```shell [pnpm]
$ pnpm install @kn-ui/icons-vue
```
...
You need import all icons from `@kn-ui/icons-vue` and register them globally.

```ts
// main.ts

// if you're using CDN, please remove this line.
import * as ElementPlusIconsVue from '@kn-ui/icons-vue'
...
```html
<script src="//unpkg.com/@kn-ui/icons-vue"></script>
```

#### jsDelivr

```html
<script src="//cdn.jsdelivr.net/npm/@kn-ui/icons-vue"></script>
```
...
<vp-script setup>
import { Edit, Share, Delete, Search, Loading } from '@kn-ui/icons-vue'
</vp-script>
