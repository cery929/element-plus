  ...
  <div class="demo-date-picker-icon">
    <div class="container">
      <div class="block">
        ...
        <el-date-picker v-model="value1" type="date" placeholder="Pick a day" format="YYYY/MM/DD"
      ...
      <div class="block">
        ...
        <el-date-picker v-model="value2" type="daterange" start-placeholder="Start date" end-placeholder="End date"
          format="YYYY/MM/DD" value-format="YYYY-MM-DD" unlink-panels>
          <template #prev-month>
            <el-icon>
              <CaretLeft />
            </el-icon>
    ...
    <div class="container">
      ...
      <div class="block">
        ...
        <el-date-picker v-model="value3" type="monthrange" start-placeholder="Start date" end-placeholder="End date"
          format="YYYY/MM/DD" value-format="YYYY-MM-DD" unlink-panels>
          <template #prev-month>
            <el-icon>
              <CaretLeft />
      ...
      <div class="block">
        ...
        <el-date-picker v-model="value4" type="yearrange" range-separator="To" start-placeholder="Start Year"
...
import { ref } from 'vue'
import { CaretLeft, CaretRight } from '@kn-ui/icons-vue'
