  ...
  <div :class="ns.b()">
    <div :class="ns.e('header')">
      <slot name="header" :date="i18nDate">
        ...
        <div v-if="validatedRange.length === 0 && controllerType === 'button'" :class="ns.e('button-group')">
          <el-button-group>
        ...
        <div v-else-if="validatedRange.length === 0 && controllerType === 'select'" :class="ns.e('select-controller')">
          <select-controller :date="date" :formatter="formatter" @date-change="handleDateChange" />
        </div>
      </slot>
    </div>
    ...
    <div v-else :class="ns.e('body')">
      <date-table v-for="(range_, index) in validatedRange" :key="index" :date="range_[0]"
        :selected-day="realSelectedDay" :range="range_" :hide-header="index !== 0" @pick="pickDay">
        <template v-if="$slots['date-cell']" #date-cell="data">
          <slot name="date-cell" v-bind="data" />
        </template>
      </date-table>
