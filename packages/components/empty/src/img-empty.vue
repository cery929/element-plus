  ...
  <svg viewBox="0 0 79 86" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
    <defs>
      <linearGradient :id="`linearGradient-1-${id}`" x1="38.8503086%" y1="0%" x2="61.1496914%" y2="100%">
        <stop :stop-color="`var(${ns.cssVarBlockName('fill-color-1')})`" offset="0%" />
        <stop :stop-color="`var(${ns.cssVarBlockName('fill-color-4')})`" offset="100%" />
      </linearGradient>
      <linearGradient :id="`linearGradient-2-${id}`" x1="0%" y1="9.5%" x2="100%" y2="90.5%">
        <stop :stop-color="`var(${ns.cssVarBlockName('fill-color-1')})`" offset="0%" />
        <stop :stop-color="`var(${ns.cssVarBlockName('fill-color-6')})`" offset="100%" />
      </linearGradient>
    ...
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
      <g transform="translate(-1268.000000, -535.000000)">
        <g transform="translate(1268.000000, 535.000000)">
          ...
          <polygon :fill="`var(${ns.cssVarBlockName('fill-color-7')})`"
          ...
          <g
            ...
            <polygon :fill="`var(${ns.cssVarBlockName('fill-color-5')})`"
              points="-3.69149156e-15 7 38 7 38 43 -3.69149156e-15 43" />
            <rect :fill="`url(#linearGradient-1-${id})`"
              transform="translate(46.500000, 25.000000) scale(-1, 1) translate(-46.500000, -25.000000) " x="38" y="7"
              width="17" height="36" />
            <polygon :fill="`var(${ns.cssVarBlockName('fill-color-2')})`"
              transform="translate(39.500000, 3.500000) scale(-1, 1) translate(-39.500000, -3.500000) "
              points="24 7 41 7 55 -3.63806207e-12 38 -3.63806207e-12" />
          </g>
          <rect :fill="`url(#linearGradient-2-${id})`" x="13" y="45" width="40" height="36" />
          <g transform="translate(53.000000, 45.000000)">
            <use :fill="`var(${ns.cssVarBlockName('fill-color-8')})`"
              transform="translate(8.500000, 18.000000) scale(-1, 1) translate(-8.500000, -18.000000) "
              :xlink:href="`#path-3-${id}`" />
            <polygon :fill="`var(${ns.cssVarBlockName('fill-color-9')})`" :mask="`url(#mask-4-${id})`"
