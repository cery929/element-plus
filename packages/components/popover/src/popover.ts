import { buildProps, isBoolean } from '@kn-ui/utils'
import {
  useTooltipContentProps,
  useTooltipTriggerProps,
} from '@kn-ui/components/tooltip'
import { dropdownProps } from '@kn-ui/components/dropdown'
...
export interface PopoverProps {
  ...
  autoClose?: number
  /**
   * @description whether a tooltip arrow is displayed or not. For more info, please refer to [ElPopper](https://github.com/kn-ui/kn-ui/tree/dev/packages/components/popper)
   */
  showArrow?: boolean
  /**
