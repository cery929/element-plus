...
import { BORDER_HORIZONTAL_WIDTH, EVENT_CODE } from '@kn-ui/constants'
import { ArrowDown, CaretTop, CircleClose } from '@kn-ui/icons-vue'
import { usePopperContainerId } from '@kn-ui/hooks'
import { hasClass } from '@kn-ui/utils'
...
describe('Select', () => {
  ...
  // fix: https://github.com/kn-ui/kn-ui/issues/11991
