...
import { ElOption } from '@cery929-ui/components/select'
...
const component = defineComponent({
  ...
  setup(props, ctx) {
    ...
    // Fix: https://github.com/cery929-ui/cery929-ui/issues/7917
    ...
    // @link https://github.com/cery929-ui/cery929-ui/blob/6df6e49db07b38d6cc3b5e9a960782bd30879c11/packages/components/select/src/option.vue#L78
    nextTick(() => {
